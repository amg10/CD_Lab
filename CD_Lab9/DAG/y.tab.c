...
#line 50 "y.y"
  {
    char temp[100];
    sprintf(temp,"%s + %s",expressions[yyvsp[-2]->id],expressions[yyvsp[0]->id]);
    ...
    else
    {
      ...
      newnode->isOp=1;
      newnode->type='+';
      newnode->left=yyvsp[-2];
      newnode->right=yyvsp[0];
      newnode->id = index1;
